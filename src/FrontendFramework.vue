    ...
    <div id="frontend-framework-demo" class="demopage">
        <div :id="templateId" class="page-wrapper">
                ...
                <div v-else>
                    <div class="closed-sidebar">
                        <a href="#" class="button primary" title="Open Template Settings"
                            @click.prevent="openBox('template')">
                            <span class="icon-home"></span>
                        </a>
                        <a href="#" class="button primary" title="Open Template Settings"
            ...
            <main id="content">
                ...
                <div class="width-limitation-wrapper">
                    <section>
                        ...
                        <h1><span class="icon-globe"></span><span>Headline 1</span></h1>
                        <h2><span class="icon-globe"></span><span>Headline 2</span></h2>
                        <h3><span class="icon-globe"></span><span>Headline 3</span></h3>
                        <h4><span class="icon-globe"></span><span>Headline 4</span></h4>
                        <h5><span class="icon-globe"></span><span>Headline 5</span></h5>
                        <h6><span class="icon-globe"></span><span>Headline 6</span></h6>
                        <h4>Headlines with Highlight-Level</h4>
                        <h1 class="primary">
                            <span class="icon-globe"></span><span>Headline 1 (primary)</span>
                        </h1>
                        <h1 class="secondary">
                            <span class="icon-globe"></span><span>Headline 1 (secondary)</span>
                        </h1>
                        <h1 class="tertiary">
                            <span class="icon-globe"></span><span>Headline 1 (tertiary)</span>
                        </h1>
                        <h3 class="headline-demopage" id="anchor-paragraphs">Paragraphs (default)</h3>
                        ...
                        <p class="text-align-justify">This is continuous text within a paragraph with text-align
                            ...
                            &lt;br
                            /&gt;,
                            &lt;a&gt;, &lt;span&gt;, &lt;strong&gt;, &lt;em&gt;, &lt;div&gt;. An additional
                            &lt;p&gt;-tag
                            inside
                            a
                            surrounding &lt;p&gt;-tag is not allowed. It should be also avoided placing to &lt;br /&gt;
                            after
                            each other
                            (use a &lt;p&gt; instead), because another paragraph is required if you want to create a
                            blank line
                            (which is
                        ...
                        <ol>
                            ...
                            <li>List item
                                <ul>
                                    <li>List item (text only)</li>
                                    <li><a href="#">List item with link (default)</a></li>
                                    <li class="active"><a href="#">List item with link (active)</a></li>
                                </ul>
                            </li>
                            <li>List item</li>
                        </ol>
                        <h4 id="anchor-description-list">Description List</h4>
                        <h5>List with texts as terms (default: dt before/left of dd)</h5>
                        <dl>
                        ...
                        <h5>List with icons as terms (default: dt before//left of dd)</h5>
                        <dl>
                        ...
                        <h5>List with text as terms (reverse: dd before/left of dt)</h5>
                        <dl>
                            <dd>Description data</dd>
                            <dt>Description term</dt>
                            <dd>Description data</dd>
                            <dt>Description term</dt>
                            <dd>Description data</dd>
                            <dt>Description term with a very long text which will wrap on small devices</dt>
                        </dl>
                        <h5>List with icons as terms (reverse: dd before/left of dt)</h5>
                        <dl>
                        ...
                        <h5>List in a row with text (default: dt before/left of dd)</h5>
                        ...
                        <h5>List in a row with text with icons (default: dt before/left of dd)</h5>
                        <dl class="auto-columns">
                            <dt><span class="icon-company" title="Company"></span></dt>
                            <dd>Description data</dd>
                            <dt><span class="icon-phone" title="Phone"></span></dt>
                        ...
                        <h5>List in a row with texts (reverse: dd before dt)</h5>
                        <dl class="auto-columns">
                            <dd>Description data</dd>
                            <dt>Description term</dt>
                            <dd>Description data</dd>
                        ...
                        <ul class="list-of-images">
                            ...
                            <li>
                                <a href="#">
                                    <img src="/images/landscape-small.jpg" alt="image with link in a list"
                                        title="image with link in a list">
                                </a>
                            </li>
                            <li>
                                <figure>
                                    <img src="/images/landscape-small.jpg" alt="image with figure in a list"
                                        title="image with figure in a list">
                            ...
                            <li>
                                <a href="#">
                                    <figure>
                                        <img src="/images/landscape-small.jpg"
                                            alt="image with figure and link in a list"
                                            title="image with figure and link in a list">
                        ...
                        <a href="#" class="primary">Hyperlink (primary/default)</a><br />
                        <a href="#" class="secondary">Hyperlink (secondary)</a><br />
                        <a href="#" class="tertiary">Hyperlink (tertiary)</a><br />
                        <a href="#" class="none">Hyperlink (none/text-color)</a>
                        ...
                        <h4>Superior/Subscript</h4>
                        <p>text<sup>superior</sup></p>
                        ...
                        <p>
                            <a href="#"><dfn
                                    title="A definition is describable text for a default terminology">Definition with a
                                    link</dfn></a>
                        </p>
                ...
                <div class="width-limitation-wrapper">
                    <section>
                        ...
                        <!--p>
                            <a href="#" id="toggle_stretch_table" title="(add/remove class 'full-width')">Toggle stretched table</a>
                        </p-->
                                        ...
                                        <td>
                                            <label class="toggle-switch" for="toggle-switch-checkbox-in-table"
                                                ...
                                                <span class="switch-label-wrapper">
                                                    ...
                                                    <span class="label-text">Yes</span><span
                    ...
                    <section>
                        ...
                        <div class="flex-container">
                            ...
                            <div class="box secondary">
                                <div class="box-header">
                                    <h4>Box with header, body and footer (secondary)</h4>
                                </div>
                                <div class="box-body" role="article">
                                    <div class="default-padding">
                                        <p>
                            ...
                            <div class="box tertiary">
                                <div class="box-header">
                                    <h4>Box with header, body and footer (tertiary)</h4>
                                </div>
                                <div class="box-body" role="article">
                                    <div class="default-padding">
                                        <p>
                        ...
                        <div class="grid-container-auto-columns" id="demopage-boxes">
                            <div class="box center-content">
                                <div>
                                    <p>Centered inside <strong>block-element</strong></p>
                                </div>
                            </div>
                            <div class="box center-content flex-container">
                                <div>
                                    <p>Centered inside <strong>flex-container</strong></p>
                                </div>
                            </div>
                            <div class="box center-content grid-container">
                                <div>
                                    <p>Centered inside <strong>grid-container</strong></p>
                                </div>
                            </div>
                        </div>
                    </section>
                ...
                <div class="width-limitation-wrapper">
                    <section>
                        ...
                        <div class="flex-container">
                            <span class="show-in-light-mode-only">This text is shown in light-mode only</span>
                            <span class="show-in-dark-mode-only">This text is shown in dark-mode only</span>
                        </div>
                    </section>
                </div>
                <!-- end colors -->
                ...
                <div class="width-limitation-wrapper">
                    <section>
                        ...
                        <div class="accordion-wrapper">
                            ...
                            <details class="primary" name="accordion">
                                <summary>
                                    <span class="icon-chevron-one-stripe-right closed"></span>
                                    <span class="icon-chevron-one-stripe-down open"></span>
                                    <h4>Summary text (in a headline) for collapsed accordion-box (primary)</h4>
                                </summary>
                                <div class="accordion-body">
                                    <p>
                                        This is long text in a paragraph with &lt;details&gt;-tag.<br />
                            ...
                            <details class="secondary" name="accordion">
                                <summary>
                                    <span class="icon-chevron-one-stripe-right closed"></span>
                                    <span class="icon-chevron-one-stripe-down open"></span>
                                    <h4>Summary text (in a headline) for collapsed accordion-box (secondary)</h4>
                                </summary>
                                <div class="accordion-body">
                                    <p>
                                        This is long text in a paragraph with &lt;details&gt;-tag.<br />
                            ...
                            <details class="tertiary" name="accordion">
                                <summary>
                                    <span class="icon-chevron-one-stripe-right closed"></span>
                                    <span class="icon-chevron-one-stripe-down open"></span>
                                    <h4>Summary text (in a headline) for collapsed accordion-box (tertiary)</h4>
                                </summary>
                                <div class="accordion-body">
                                    <p>
                                        This is long text in a paragraph with &lt;details&gt;-tag.<br />
                        ...
                        <div class="flex-container flex-direction-column">
                            <div class="button-wrapper align-left">
                                ...
                                <button class="button active">
                                    <span>Default button active</span>
                                </button>
                            </div>
                            <div class="button-wrapper align-left">
                                <a href="#" class="button primary" role="button">
                            ...
                            <div class="button-wrapper align-left">
                                <a href="#" class="button secondary" role="button">
                                    <span>Secondary button with a-tag</span>
                                </a>
                                <button class="button secondary">
                                    <span>Secondary button with button-tag</span>
                                </button>
                                <button class="button secondary active">
                                    <span>Secondary button active</span>
                                </button>
                            </div>
                            <div class="button-wrapper align-left">
                                <a href="#" class="button tertiary" role="button">
                                    <span>Tertiary button with a-tag</span>
                                </a>
                                <button class="button tertiary">
                                    <span>Tertiary button with button-tag</span>
                                </button>
                                <button class="button tertiary active">
                                    <span>Tertiary button active</span>
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="flex-container">
                            ...
                            <div>
                                <h4>Primary</h4>
                                <small class="tag primary">Tag 1</small>
                                <small class="tag primary">Tag 2</small>
                                <small class="tag primary">Tag 3</small>
                            </div>
                            <div>
                                <h4>Secondary</h4>
                                <small class="tag secondary">Tag 1</small>
                                <small class="tag primary secondary">Tag 2</small>
                                <small class="tag primary secondary">Tag 3</small>
                            </div>
                            <div>
                                <h4>Tertiary</h4>
                                <small class="tag tertiary">Tag 1</small>
                                <small class="tag tertiary">Tag 2</small>
                                <small class="tag tertiary">Tag 3</small>
                            </div>
                        </div>
                    </section>
                </div>
                ...
                <div class="width-limitation-wrapper">
                    <section>
                        ...
                        <h3 id="anchor-native-form-elements">Native form elements</h3>
                        <form method="post">
                            <fieldset class="flex-container">
                                ...
                                <div class="label inline">
                                    ...
                                    <span class="flex-container flex-none">
                                        ...
                                        <label for="radio2">
                                            <input name="radiogroup" id="radio2" value="2" type="radio"
                                                checked="checked" />
                                ...
                                <label class="inline" for="datefield">
                                    <span class="label-text"><span>Label for (required) datefield
                        ...
                        <h3 id="anchor-form-validation">Form Validation</h3>
                        <h4>No validation</h4>
                        <dl>
                            <dt>Validation:</dt>
                            <dd>None</dd>
                            ...
                            <dd>None</dd>
                            <dt>Styling:</dt>
                            <dd>Native/Pseudo-classes</dd>
                        </dl>
                        <form novalidate="novalidate">
                            <fieldset class="flex-container">
                                <legend>Form without validation</legend>
                                <div class="flex-container">
                                    <label for="inputfield-without-validation">
                                        <span class="label-text">
                        ...
                        <h4>Native validation</h4>
                        <dl>
                            <dt>Validation:</dt>
                            <dd>Native/By browser</dd>
                            <dt>Messages:</dt>
                            <dd>Native/By browser</dd>
                            <dt>Styling:</dt>
                            <dd>Native/Pseudo-classes</dd>
                            ...
                            <fieldset class="flex-container">
                                ...
                                <div class="flex-container align-items-top">
                                    ...
                                    <label>
                                        ...
                                        <textarea name="textarea-with-native-validation"
                                            id="textarea-with-native-validation" required="required"
                        ...
                        <dl>
                            ...
                            <dd>None</dd>
                            <dt>Messages:</dt>
                            <dd>Custom/Tooltips</dd>
                            <dt>Styling:</dt>
                            <dd>Custom/Classes</dd>
                        </dl>
                        <form data-use-validation="true" novalidate="novalidate">
                            <fieldset class="flex-container">
                                <legend>Form with custom validation</legend>
                                <h5>Inputfields</h5>
                                <div class="flex-container align-bottom">
                        ...
                        <form>
                            <fieldset class="flex-container">
                                ...
                                <label for="textfield01">
                                    <span class="label-text">Label with some Text</span>
                                    <input id="textfield01" placeholder="Placeholder text" type="text" />
                                </label>
                                <!-- begin replace input-type-radio -->
                                <h4>Replaced Input-Type-Radio</h4>
                                <div class="label inline">
                                    <span class="label-text">
                                ...
                                <!-- end replace input-type-radio -->

                                <!-- begin replace-input-type-checkbox -->
                                    ...
                                    <span class="flex-container flex-none">
                                        ...
                                        <label for="replaced-checkbox4">
                                            <input type="checkbox" class="replace-input-type" id="replaced-checkbox4"
                                                name="checkboxgroup" value="4" disabled="disabled" checked="checked" />
                                            <span class="label-text">Label 4 (checked and disabled)</span>
                                        </label>
                                    </span>
                                </div>
                                <!-- end replace-input-type-checkbox -->

                                <hr />

                                <!-- begin toggle-switch-radio -->
                                ...
                                <div class="label inline">
                                    ...
                                    <span class="flex-container flex-none">
                                        ...
                                        <label class="toggle-switch" for="toggle-switch-checkbox2"
                                            title="checked (by default)">
                                            <span class="switch-label-wrapper">
                                                <input type="checkbox" id="toggle-switch-checkbox2"
                                                    name="chechboxgroup3" value="2" checked="checked" />
                                                <span class="label-text">Yes</span><span class="label-text">No</span>
                                            </span>
                                            <span>Label #2</span>
                                        </label>
                                        <label class="toggle-switch disabled" for="toggle-switch-checkbox3"
                                            title="disabled">
                                            <span class="switch-label-wrapper">
                                                <input type="checkbox" id="toggle-switch-checkbox3"
                                                    name="chechboxgroup3" value="3" disabled="disabled" />
                                                <span class="label-text">Yes</span><span class="label-text">No</span>
                                            </span>
                                            <span>Label #3</span>
                                        </label>
                                        <label class="toggle-switch disabled" for="toggle-switch-checkbox4"
                                            title="checked and disabled">
                                            <span class="switch-label-wrapper">
                                                <input type="checkbox" id="toggle-switch-checkbox4"
                                                    name="chechboxgroup3" value="4" disabled="disabled"
                                                    checked="checked" />
                                                <span class="label-text">Yes</span><span class="label-text">No</span>
                                            </span>
                                            <span>Label #4</span>
                                ...
                                <!-- end toggle-switch-checkbox with switch-label -->
                                ...
                                <div class="flex-container align-bottom">
                                    ...
                                    <label for="password">
                                        <span class="label-text">
                                            <span>Password (required):<sup>*</sup></span>
                                        </span>
                                        <span class="flex-container">
                                        ...
                                        <ul>
                                            <li class="has-subentries">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="#">Entry 2.1.3</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="#">Entry 2.2</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="http://www.comand-cms.com" target="_blank">CoManD-CMS</a></li>
                                </ul>
                            </nav>
                        </div>
                    </section>
                ...
                <div class="width-limitation-wrapper">
                    <section id="grid-section">
                        ...
                        <!--h3 class="headline-demopage">Simple Grid</h3>
                        <form novalidate="novalidate">
                            <div class="fieldset grid-container-create-columns">
                                <div class="grid-container-create-columns"  data-columns-large="4">
                                    <label for="grid-columns">
                                        <span>Grid-Columns (Fractions):</span>
                                        <input type="number" id="grid-columns" value="12" maxlength="2" />
                                    </label>
                                    <label for="grid-rows">
                                        <span>Grid-Rows (Fractions):</span>
                                        <input type="number" id="grid-rows" value="1" maxlength="2"  />
                                    </label>
                                    <label for="grid-gap">
                                        <span>Grid-Gap (Pixels):</span>
                                        <input type="number" id="grid-gap" value="10" maxlength="3" />
                                    </label>
                                    <label for="grid-reset">
                                        <span>Reset grid values:</span>
                                        <button id="grid-reset">Reset</button>
                                    </label>
                                </div>
                            </div>
                        </form-->
                        <h3 id="anchor-grid-containers-regular-grid">Regular Grid</h3>
                        <div class="grid-container-create-columns" id="grid-regular">
                            <div>1</div>
                            <div>2</div>
                            <div>3</div>
                            <div>4</div>
                        ...
                        <h3 id="anchor-grid-containers-default-classes">Grid based on default classes</h3>
                        <div class="grid-container-create-columns" id="grid-default">
                            <div class="grid-small-item">Small item</div>
                        ...
                        <h3 id="anchor-grid-containers-two-fractions">Grid two fractions (with same width)</h3>
                        <div class="grid-container-create-columns">
                            <div class="grid-item-half-width">grid-item</div>
                            <div class="grid-item-half-width">grid-item</div>
                        </div>

                        <h3 id="anchor-grid-containers-complex-grid">Complex Grid</h3>
                        <div class="grid-container" id="grid-complex">
                            <div>1</div>
                            <div>2</div>
                            <div>3</div>
                            <div>4</div>
            ...
            <div class="copyright-information" role="contentinfo">
                <a href="https://www.comand-ui.com" target="_blank" lang="en" title="CoManD-UI-Website">© CoManD-UI</a>
            </div>
